...
const Banner = () => {
  ...
  return (
    <main
      ...
      className="main-banner w-full min-h-screen flex flex-col justify-between bg-black text-white relative overflow-hidden"
    >
      {/* Top Section */}
      ...
      {/* Center Section with Scrolling Text Start */}
      <div className="flex flex-col items-center justify-center flex-1 relative mt-56">
        <motion.div
        ...
        >
          <ScrollVelocity
            text="MERN Stack Developer * React Developer * Full Stack Developer * Wordpress Devleoper * Shopify Developer * MERN Stack Developer * React Developer * Full Stack Developer * Wordpress Devleoper * Shopify Developer *"
            velocity={60}
