        ...
        >
          ...
          >
            <p className="font-dmsans text-[#616161] text-right text-2xl font-light max-sm:text-xs max-sm:w-full">
              Being a self taught developer, I’ve learned the importance of
              clear structure and smooth user flow. Whether it’s a website or a
              full scale application, I focus on making every page and feature
              intuitive, easy to navigate, and purposeful.
            </p>
