  ...
  return (
    ...
    >
      <motion.div
        ...
        className={`${className} absolute w-fit bg-[#171717] bottom-3 left-1/2 transform -translate-x-1/2 flex items-end w-fit gap-4 rounded-2xl border-neutral-700 border-2 pb-2 px-4`}
