    ...
    >
      ...
      <div className="flex flex-col items-center justify-center">
        <motion.div
          ...
          className="w-[75%] py-12 max-2xl:w-[90%]"
        >
          <h2 className="text-white font-dmsans font-normal text-center text-[148px] leading-none max-sm:text-3xl max-sm:w-full max-2xl:text-[120px]">
            Wild projects &<br /> Awesome creations
          </h2>
        </motion.div>
      </div>
