...
const Banner = () => {
  ...
  return (
    ...
    <main
      ...
      className="electro-banner w-full min-h-screen flex flex-col justify-between bg-black text-black relative overflow-hidden max-sm:bg-contain max-sm:bg-no-repeat max-sm:min-h-[350px] max-sm:bg-bottom max-sm:h-[350px]"
    >
      {/* Top Section */}
